...
public class Entity {
    ...
    // Deklaracje zmiennych
        ...
        // podtyp klasy entity, w celu pozniejszego rozroznienia instancji klas dziedziczących do np rysowania
    ...
    // metoda do overwrite'a, jest jako "wzorzec" dla klas dziedziczacych, jesli bedziemy chcieli wzbogacic gre o inne podmioty
    ...
    public void update(){
        ...
        // dodane w celu "nietracenia" calego zycia w 0,01 sekundy po dotknieciu potwora przez gracza, 
        ...
        // poruszanie podmiotu, wykorzystywane przez albo keyhandlera, albo prosty system imituajcy AI - losowanie kierunku przez potwory
    ...
    public void deleteInstance(Entity[] array, int index) {
        ...
        // okreslenie "ktory" potwor jest do usuniecia
    ...
    // metoda do rysowania potworow, wiemy ze powinna byc ona w klasie od potworow wedle zasady podzialu odpowiedzialnosc S (SOLID)
    // Natomaist tutaj ona powstala na poczatku i tutaj poki co zostanie, poprawimy dalej
    public void draw(Graphics2D g2){
        ...
        // optymalne rysowanie potwora, jesli jest w obrebie ekranu to jest rysowany, jesli nie to nie
        ...
        if(worldX > gb.player.worldX - 2*gb.player.screenX - gb.finalTileSize && 
                ...
                worldY < gb.player.worldY + 2*gb.player.screenY + gb.finalTileSize){
                    ...
                    // baaaaardzo niepotrzebny switch case, ale jest on buforem miejsca na dalszy rozwoj gry
                    switch(direction){
                        case "up":
                            image = imageMonster;
                            break;
